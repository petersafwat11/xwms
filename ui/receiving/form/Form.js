...
import {  receivingInitialState } from '@/utils/IntialState'
...
const Form = ({id, company, entity_code, fetchedData}) => {
    ...
    // Form data and state
    const [data, setData] = useState(fetchedData?fetchedData:{...receivingInitialState, company: company, entity_code: entity_code});
    ...
    const handleSubmit = async () => {
        if (!validateForm(data, receivingRequiredDbFields)) {
            setErrors({
                ...errors,
        ...
        try {
            ...
            toast.success(id === 'create' ? 'Receiving created successfully!' : 'Receiving updated successfully!');
        ...
        <div className={styles.form}>
            <div className={styles.form_header}>
                <h1 className={styles.form_title}>
                    {isCreateMode ? 'Create New Receiving' : 'Edit Receiving'}
                </h1>
            </div>
